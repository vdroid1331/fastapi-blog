...
from app.paths import PROFILE_PICS_DIR, POPULATE_IMAGES_DIR
...
POSTS = [
    ...
    {
        "title": "Rajma Chawal is the best food item!",
        "content": "Rajma Chawal is a delicious and hearty dish that I absolutely love. It's a perfect combination of kidney beans and rice, seasoned with aromatic spices. Whether it's a quick lunch or a comforting dinner, this dish never disappoints.",
    },
    {
...
POST_44 = {
    "title": "Fun Fact: Favourite Cricketer is Sachin Tendulkar",
    "content": "Sachin Tendulkar is widely regarded as one of the greatest cricketers of all time. His dedication and skill have made him a legend in the sport. Truly deserves the title of 'God of Cricket'.",
}
